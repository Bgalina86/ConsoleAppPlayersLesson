...
#6. Добавить очков поверх существующих (4) - done
#7. (добавить игрока) - получить игрока по id (3, 5) - done
8. проверить корректность сохранения в файл (1, 4, 6) - отдельно
9. проверить корректность загрузки json-файла - отдельно
- не потеряли записи (7)
- не "побили" записи (4, 7)
#10. Проверить, что id всегда уникальный. Создать 5, удалить 3-го, добавить еще одного -> id == 6 (а не 3) (1, 2) - done
11. (нет json-файла) запросить список игроков (3, 8)
#12. Проверить создание игрока с 15 символами (10) - done

###Негативные
1. удалить игрока, которого нет - удалить игрока 10, хотя последний - 8 (2, 3)
#2. создать дубликат (имя уже занято) (9) - done
- создать игрока
